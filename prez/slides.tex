...
% TODO: Justin: add dotted line at zero (maybe)
...
% TODO: Justin: add dotted line at zero (def)
% Walk them through what the axes are.
...
% The way Stephen would explain it is this:
...
\begin{frame}[c]{Census plot with I2 only} % Stephen
...
\begin{frame}[c]{Census plot with \textbf{CI2}} % Stephen
